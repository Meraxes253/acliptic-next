    ...
    <div id="how-it-works" className="min-h-screen bg-gray-50 py-20 px-40">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="relative">
          ...
          {/* Username label */}
          <div className="absolute bottom-2 right-12 text-white text-xl font-medium flex items-center gap-2 denton-condensed">
            Auto Import
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-download">
        ...
        <div className="relative ml-10 flex items-center">
          ...
          <div className="relative">
            ...
            {/* Username label */}
            <div className="absolute bottom-6 left-[50px] text-white text-xl font-medium flex items-center gap-2 denton-condensed">
              Auto Editing
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-edit">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
          ...
          <div className="relative -ml-5">
            ...
            {/* Username label */}
            <div className="absolute bottom-5 left-14 text-white text-xl font-medium flex items-center gap-2 denton-condensed">
              Auto Upload
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-upload">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" />
                <path d="M7 9l5 -5l5 5" />
                <path d="M12 4l0 12" />
