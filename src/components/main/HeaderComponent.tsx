      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 -mt-20">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center relative">
          ...
          <div className="relative mx-4 z-10">
            ...
            <div className="absolute top-20 -right-48 bg-white text-gray-800 px-6 py-4 rounded-full text-s font-medium leading-tight whitespace-nowrap text-center shadow-lg z-20">
              All Done Live<br />
            ...
            <div className="relative z-10">
              ...
              <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 w-[500px] z-20">
                <div className="bg-white rounded-full px-4 py-3 shadow-lg flex items-center justify-between">
                  <div className="flex items-center space-x-3 flex-1">
                    <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                    </svg>
                    <span className="text-gray-400 text-sm font-medium">Link your twitch account and start clipping</span>
                  </div>
                  <div className="relative">
                    <button className="bg-gradient-to-r from-[#828282] to-[#68787F] to-[#95A2B1] hover:from-[#75787F] hover:to-[#95A2B1] text-white px-6 py-2.5 rounded-full text-sm font-medium transition-all whitespace-nowrap ml-4 relative z-10">
                      Get Started
                      <div className="text-xs text-gray-200 -mt-0.5">Clip now</div>
                    </button>
