// src/app/Library/stream/[streamIndex]/clips/page.tsx
import { auth } from "@/auth";
import { db } from "@/db";
import { users } from "@/db/schema/users";
import { eq } from "drizzle-orm";
import LibraryClipsPageComponent from '@/components/Library/LibraryClipsPage'
import Navigation from "@/components/afterNav";


export default async function LibraryClipsPage() {
  ...
  return (
    ...
    <LibraryClipsPageComponent user={user} />
    </>
  );
}